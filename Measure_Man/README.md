...
- Set the switch of "Measure Man" to "Voltage Mode" to check for discontinuity.
...
- Set the switch of "Measure Man" to "Ampere Mode" to check for continuity.
- Rotate the upper rotary switch to see if the continuity beeps on every line.
...
- Some modules will need a powerup time so do not turn the rotary switch too fast since it will loose power for an instance while rotating the switch.
